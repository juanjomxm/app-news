...
function SearchNewsDev(){
    ...
    const viweNewsDev = async()=>{
        const URL = (`https://newsapi.org/v2/everything/?apiKey=5a03cee5e2594c8ea66e80860c45fbba&q=${searchNews}&language=es&sortBy=publishedAt&pageSize=10`)
    ...
    React.useEffect(()=>{
        const viweNewsDevStart = async()=>{
            const URL2 = `https://newsapi.org/v2/everything/?apiKey=5a03cee5e2594c8ea66e80860c45fbba&q=guerra&language=es&sortBy=publishedAt&pageSize=10`
